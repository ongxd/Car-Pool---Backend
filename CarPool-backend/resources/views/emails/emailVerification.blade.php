                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td align="center" bgcolor="#1a82e2" style="border-radius: 6px;">
                                                    <a href="http://127.0.0.1:8000/email-verified/{{ $id }}"
                                                        target="_blank"
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <p style="margin: 0;">If that doesn't work, copy and paste the following link in your
                                browser:</p>
                            <p style="margin: 0;"><a href="http://127.0.0.1:8000/email-verified/{{ $id }}"
                                    target="_blank">http:127.0.0.2/email-verified/{{ $id }}</a></p>
                        </td>
                    </tr>
                    <!-- end copy -->
